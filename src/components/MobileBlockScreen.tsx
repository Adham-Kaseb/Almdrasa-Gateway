      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center w-8">
            <div className="w-8 h-8 rounded-full bg-white/[0.04] border border-white/10 flex items-center justify-center text-[#DFCA9F]">
        ...
        <motion.div
          className="w-full rounded-2xl bg-gradient-to-b from-[#181715]/95 to-[#12110F]/95 border border-white/10 p-4.5 sm:p-5 shadow-[0_24px_64px_rgba(0,0,0,0.7)] backdrop-blur-xl mb-6 text-right"
          variants={ITEM_VARIANTS}
        >
          ...
          <ul className="space-y-3" role="list">
            {FEATURES.map(({ icon: Icon, title, desc, badge }) => (
              <li
                key={title}
                className="flex items-start gap-3 p-2 rounded-xl bg-white/[0.02] hover:bg-white/[0.04] transition-colors"
              >
        ...
        <motion.div
          className="inline-flex items-center gap-2.5 px-6 py-3 rounded-2xl bg-gradient-to-r from-[#DFCA9F]/15 via-[#DFCA9F]/10 to-[#CCA868]/15 border border-[#DFCA9F]/35 shadow-[0_8px_20px_rgba(223,202,159,0.1)]"
          variants={ITEM_VARIANTS}
        >
