  ...
  const filteredCountries = useMemo(() => {
    return ARAB_COUNTRIES_SCHEDULE.filter((country: ArabCountrySchedule) => {
      if (timeFilter !== "all") {
        ...
        if (timeFilter === "behind1" && country.offsetHours !== -1)
          return false;
        if (timeFilter === "behind2" && country.offsetHours !== -2)
          return false;
      }
  ...
  return (
    <div className="h-full flex flex-col bg-[#4700D8] text-[#1E1D1A] overflow-hidden select-text font-sans relative">
      ...
      >
        ...
        <div className="max-w-5xl mx-auto rounded-4xl bg-white p-6 sm:p-8 md:p-10 shadow-[0_24px_80px_rgba(0,0,0,0.3)] border border-white/60 space-y-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 rounded-2xl bg-linear-to-b from-[#F7F4FF] to-[#EDE5FF] border border-[#DCD0FF] flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-[#4A453E] mt-1.5 leading-relaxed">
                  تنطلق الجلسة في تمام الساعة{" "}
                  <strong>6:00 مساءً (بتوقيت القاهرة)</strong> بانتظام على مدار
                  فترة المنحة.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-linear-to-b from-[#F7F4FF] to-[#EDE5FF] border border-[#DCD0FF] flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-[#4A453E] mt-1.5 leading-relaxed">
                  يتواجد المشرف من <strong>6:00 م حتى 6:30 م</strong>. إذا تواجد
                  طلاب، يستمر الاجتماع بلا وقت إلزامي للنهاية حتى حل جميع
                  استفساراتهم.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
              <div className="p-4 rounded-2xl bg-linear-to-b from-[#F7F4FF] to-[#EDE5FF] border border-[#DCD0FF] text-center flex flex-col items-center">
                ...
                <div className="text-sm font-extrabold text-[#191816]">
                  1. تجهيز الكود مسبقاً
                </div>
                <p className="text-xs text-[#524D44] mt-1.5 leading-relaxed">
                  حدد السطر البرمجي ورسالة الخطأ من الـ Console قبل دخول الجلسة
                  لسرعة التشخيص.
                </p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-linear-to-b from-[#F7F4FF] to-[#EDE5FF] border border-[#DCD0FF] text-center flex flex-col items-center">
                ...
                <div className="text-sm font-extrabold text-[#191816]">
                  2. مشاركة الشاشة المباشرة
                </div>
                <p className="text-xs text-[#524D44] mt-1.5 leading-relaxed">
                  شارك شاشة VS Code والمتصفح ليتمكن المهندس من مراجعة البنية
                  وتصحيح المسار فوراً.
                </p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-linear-to-b from-[#F7F4FF] to-[#EDE5FF] border border-[#DCD0FF] text-center flex flex-col items-center">
                ...
                <p className="text-xs text-[#524D44] mt-1.5 leading-relaxed">
                  قم بتطبيق الحل البرمجي وتشغيله أثناء تواجد المشرف للتأكد من
                  زوال المشكلة تماماً.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                <h3 className="text-base sm:text-lg font-black text-[#191816] flex items-center gap-2">
                  ...
                  <span>
                    جدول مواعيد الاجتماع لكافة الدول العربية (22 دولة)
                  </span>
                </h3>
                <p className="text-xs text-[#6B655B] mt-0.5">
                  تحويل فوري لموعد بدء الاجتماع ونافذة تواجد المشرف حسب التوقيت
                  المحلي لبلدك
                </p>
              </div>
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-linear-to-r from-[#F6F1FF] to-[#EDE4FF] border border-[#D3BEFF] flex flex-col sm:flex-row items-start gap-3.5">
            ...
            <div className="space-y-1 text-xs sm:text-[13px] text-[#3D3830] leading-relaxed">
              ...
              <p>
                يتم احتساب المواعيد وفق توقيت القاهرة الشتوي (UTC+2) أو الصيفي
                (UTC+3) عند تفعيله رسمياً في مصر. في حال تطبيق التوقيت الصيفي
                بمصر، يتطابق التوقيت مباشرة مع مكة المكرمة والرياض والدوحة
                وعمّان ودمشق.
              </p>
              <div className="pt-1 flex items-center gap-4 flex-wrap text-[11px] font-semibold text-[#5B00FF]">
                <span className="inline-flex items-center gap-1">
                  <CheckCircle2 className="w-3.5 h-3.5" /> متصفح Chrome أو Edge
                  محدث
                </span>
                <span className="inline-flex items-center gap-1">
