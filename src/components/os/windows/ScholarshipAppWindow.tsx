...
export const ScholarshipAppWindow: React.FC = () => {
  ...
  const faqList: FAQItem[] = [
      ...
      content: (
        <div className="space-y-3">
          <p className="text-[13.5px] text-[#2C2822] leading-relaxed">
            هي{" "}
            <strong>دبلومة المدرسة للواجهة الأمامية (Frontend Diploma)</strong>{" "}
            ولكن بتخفيض استثنائي كبير بنسبة <strong>87%</strong>. فبدلاً من أن
            يشتري الطالب الدبلومة بسعرها الرسمي البالغ{" "}
            <strong>34,000 ج.م</strong>، يتاح له مرة واحدة كل عام الاستفادة من
            المنحة والحصول عليها بمبلغ <strong>4,500 ج.م</strong> فقط.
          </p>
          <div className="flex flex-wrap items-center gap-3 p-3 rounded-xl bg-[#5B00FF]/8 border border-[#5B00FF]/20 text-[13px]">
            <div className="flex items-center gap-1.5">
              ...
              <span className="line-through text-[#5B00FF]/50 font-semibold">
                34,000 ج.م
              </span>
            </div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[#5B00FF] font-bold text-[15px]">
                4,500 ج.م
              </span>
            </div>
    ...
    },
    {
      ...
      shortAnswer:
        "نظامين: كاش 4,500ج دفعة واحدة أو تقسيط 900ج شهرياً لمدة 6 شهور.",
      content: (
        <div className="space-y-3">
          <p className="text-[13.5px] text-[#2C2822] leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="p-3.5 rounded-xl bg-[#5B00FF]/6 border border-[#5B00FF]/15 shadow-2xs">
              <div className="flex items-center justify-between mb-1.5">
                <span className="text-[12px] font-bold text-[#5B00FF]">
                  1. نظام الكاش (دفع مرة واحدة)
                </span>
                <CreditCard className="w-4 h-4 text-[#5B00FF]" />
              </div>
              <div className="text-[20px] font-bold text-[#1E1D1A]">
                4,500 ج.م
              </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p className="text-[13.5px] text-[#2C2822] leading-relaxed">
            المنحة مدتها <strong>12 شهراً كاملين</strong>، مقسمين بدقة إلى
            مرحلتين أساسيتين لدعم مسيرتك:
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="p-3.5 rounded-xl bg-[#5B00FF]/6 border border-[#5B00FF]/15">
              <div className="text-[11.5px] font-semibold text-[#5B00FF]">
                المرحلة الأولى (الأساسية)
              </div>
              <div className="text-[18px] font-bold text-[#1E1D1A] mt-0.5">
                9 أشهر دراسية
              </div>
              <p className="text-[11.5px] text-[#555] mt-1 leading-relaxed">
                وهي المدة الرئيسية والأساسية لإنهاء كامل مقررات ومشاريع
                الدبلومة.
              </p>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-[#5B00FF]/6 border border-[#5B00FF]/15">
              <div className="text-[11.5px] font-semibold text-[#5B00FF]">
                مرحلة الأمان (عند التعثر)
              </div>
              <div className="text-[18px] font-bold text-[#1E1D1A] mt-0.5">
                3 أشهر مجانية تماماً
              </div>
              <p className="text-[11.5px] text-[#555] mt-1 leading-relaxed">
                في حالة تعثر الطالب يحصل على 3 شهور زيادة مجاناً دون أي تكلفة
                إضافية.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2 p-3 rounded-xl bg-amber-50 border border-amber-200 text-[12px] text-[#555]">
            ...
            <span>
              <strong>سياسة التمديد بعد 12 شهراً:</strong> انطلاقاً من هذه
              الدفعة، لا يُسمح بأي تمديد مجاني بعد انقضاء الـ 12 شهراً. وفي حال
              الرغبة بالتمديد، يكون التمديد مدفوعاً بنفس قيمة القسط المعتاد (
              <strong>900 ج.م</strong>).
            </span>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-2.5">
          <p className="text-[13.5px] text-[#2C2822] leading-relaxed">
            الإجابة المباشرة والبسيطة:{" "}
            <strong>
              أي شخص غير مقتدر على شراء الدبلومة بسعرها الرسمي (34,000 ج.م).
            </strong>
          </p>
          <div className="p-3.5 rounded-xl bg-[#5B00FF]/6 border border-[#5B00FF]/15 flex items-center gap-3 text-[12.5px] text-[#2C2822]">
            ...
            <span>
              المنحة مبادرة سنوية لدعم الشباب والطلبة الجادين لتمكينهم من تعلم
              البرمجة وبناء مسار مهني مستقل دون عوائق مالية.
            </span>
          </div>
        </div>
      ),
    },
    {
      ...
      shortAnswer:
        "المنحة: مدة 12 شهر ونظام إقصاء | الشراء: وصول دائم مدى الحياة وتحديثات مجانية.",
      content: (
        <div className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
            ...
            <div className="p-4 rounded-xl bg-[#5B00FF]/6 border border-[#5B00FF]/15">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-bold text-[14px] text-[#1E1D1A]">
                  1. في إطار المنحة
                </h4>
              </div>
              <ul className="space-y-2 text-[12.5px] text-[#2C2822]">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>مدة محددة:</strong> 12 شهراً إجمالاً (9 شهور أساسية
                    + 3 شهور أمان).
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#5B00FF] shrink-0 mt-1.5" />
                  <span>
                    <strong>نظام الانضباط:</strong> يتضمن فرصتي (2) إقصاء لضمان
                    الجدية والإنجاز.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#5B00FF] shrink-0 mt-1.5" />
                  <span>
                    <strong>التكلفة:</strong> مخفضة جداً بنسبة 87% (4,500 ج.م
                    فقط).
                  </span>
                </li>
              </ul>
            ...
            <div className="p-4 rounded-xl bg-[#5B00FF]/6 border border-[#5B00FF]/15">
              ...
              <ul className="space-y-2 text-[12.5px] text-[#2C2822]">
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#5B00FF] shrink-0 mt-1.5" />
                  <span>
                    <strong>وصول مدى الحياة:</strong> المحتوى والدبلومة معك
                    للأبد دون أي مهلة انتهاء.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#5B00FF] shrink-0 mt-1.5" />
                  <span>
                    <strong>تحديثات مجانية مستمرة:</strong> كل مسار من المسارات
                    الـ 4، أي دورة تدريبية جديدة تصدر له تصلك مجاناً تماماً مدى
                    الحياة.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#5B00FF] shrink-0 mt-1.5" />
                  <span>
                    <strong>التكلفة:</strong> السعر الكامل المعتاد (34,000 ج.م).
                  </span>
                </li>
              </ul>
            </div>
    ...
    },
    {
      ...
      shortAnswer:
        "تدريب شهرين في homains مدفوع للأوائل + إشراف مجاني كامل من مهندسين في نفس تخصصك.",
      content: (
        <div className="space-y-3.5">
          <p className="text-[13.5px] text-[#2C2822] leading-relaxed">
            الذي يميّز منحة المدرسة هو الجمع النادر بين التعلم النظري الرصين
            والتدريب العملي الحقيقي في كبرى الشركات:
          </p>
          ...
          <div className="p-4 rounded-xl bg-[#5B00FF]/6 border border-[#5B00FF]/15">
            ...
            <p className="text-[12.5px] text-[#2C2822] leading-relaxed">
              التدريب الميداني الذي نتكفل بكامل ثمنه للأوائل بعد التخرج. تدريب
              حقيقي مدته <strong>شهرين داخل مصر بشركة homains</strong>. فرصة
              سهلة وسريعة ومضمونة لتدريب تدفع المنصة تكلفته بالكامل.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="p-3.5 rounded-xl bg-[#5B00FF]/6 border border-[#5B00FF]/15">
              <div className="flex items-center gap-2 text-[#5B00FF] font-bold text-[12.5px] mb-1">
                <span className="text-[#5B00FF] font-black text-lg leading-none">
                  ✱
                </span>
                <span>2. سنة كاملة من التأسيس والتخصص</span>
              </div>
              <p className="text-[12px] text-[#2C2822] leading-relaxed">
                في خلال سنة كاملة تتعلم أساسيات البرمجة وتتقن مجالاً محترماً
                يضمن لك دخلاً ممتازاً وفرص عمل حقيقية.
              </p>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-[#5B00FF]/6 border border-[#5B00FF]/15">
              ...
              <p className="text-[12px] text-[#2C2822] leading-relaxed">
                خدمة الإشراف والمتابعة <strong>مجاناً تماماً</strong> معك طوال
                مدة المنحة، ومشرفوك يعملون في نفس تخصصك لنقل خبرة واقعية.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="h-full flex flex-col bg-[#4700D8] text-[#1E1D1A] overflow-hidden select-text font-sans relative">
      ...
      <header className="relative z-10 px-6 py-3 flex items-center justify-between border-b border-white/10 bg-black/15 backdrop-blur-md text-white shrink-0 gap-3">
        <div className="shrink-0">
          ...
          <div className="text-[10px] sm:text-[11px] text-[#D0C0FF]">
            منحة مدرسة Almdrasa • الدفعة السادسة
          </div>
        </div>
      ...
      <div
        ref={containerRef}
        className="flex-1 relative z-10 overflow-y-auto p-5 md:p-8"
      >
        <div className="max-w-4xl mx-auto space-y-5">
          {/* Page Title */}
          <div className="text-white mb-2">
            <h1 className="text-[22px] md:text-[26px] font-black leading-tight tracking-tight">
              كل ما يخص منحة المدرسة
            </h1>
            <p className="text-[12.5px] text-[#D0C0FF] mt-1 leading-relaxed">
              إجابات واضحة لكل ما يتعلق بدبلومة الواجهة الأمامية، الخصم، أنظمة
              السداد، المدة، وتدريب الأوائل.
            </p>
          </div>
            ...
            {filteredFAQs.length === 0 ? (
              ...
              filteredFAQs.map((faq, idx) => (
                ...
                >
                  ...
                  {/* Answer Content */}
                  <div className="pt-1">{faq.content}</div>
          ...
          <div className="rounded-3xl bg-white/10 border border-white/20 backdrop-blur-md p-4 flex items-center gap-3 text-[12.5px] text-white">
            <Award className="w-5 h-5 text-white/70 shrink-0" />
            <span>
              <strong>خلاصة المنحة:</strong> سنة دراسية كاملة + تدريب عملي شهرين
              في شركة homains للأوائل + إشراف مجاني متواصل لضمان وصولك لسوق
              العمل.
            </span>
          </div>
